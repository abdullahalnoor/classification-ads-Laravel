                ...
                <div class="side-bar col-md-3">
                    ...
                    <div class="w3ls-featured-ads">
                        ...
                        <div class="w3l-featured-ad">
                            <a href="single.html">
                                <div class="w3-featured-ad-left">
                                    <img src="{{asset('/front')}}/images/f1.jpg" title="ad image" alt="" />
                                </div>
                        ...
                        <div class="w3l-featured-ad">
                            <a href="single.html">
                                <div class="w3-featured-ad-left">
                                    <img src="{{asset('/front')}}/images/f2.jpg" title="ad image" alt="" />
                                </div>
                                <div class="w3-featured-ad-right">
                                    <h4>Lorem Ipsum is simply dummy text of the printing industry</h4>
                                    <p>$ 380</p>
                        ...
                        <div class="w3l-featured-ad">
                            <a href="single.html">
                                <div class="w3-featured-ad-left">
                                    <img src="{{asset('/front')}}/images/f3.jpg" title="ad image" alt="" />
                                </div>
                                <div class="w3-featured-ad-right">
                                    <h4>Lorem Ipsum is simply dummy text of the printing industry</h4>
                                    <p>$ 560</p>
                                        ...
                                        <div id="container">
                                            ...
                                            <ul class="list">
                                                ...
                                                <a href="{{ url('/product/product-details/'.$product->id) }}">
                                                    <li>
                                                        <img src="{{asset($product->product_image)}}" title="" alt="" />
                                                        <section class="list-left">
                                                            <h5 class="title">{{$product->product_title}}</h5>
                                                            <span class="adprice">Tk. {{$product->product_price}}</span>
                                                        </section>
                                                        <section class="list-right">

                                                            <span class="cityname">Location: Dhaka, BD</span>
                                                        </section>
                                                        <div class="clearfix"></div>
                                                    </li>
                                                </a>
                                    ...
                                    <div>
                                        <div id="container">
                                            ...
                                            <ul class="list">
                                                <a href="single.html">
                                                    <li>
                                                        <img src="{{asset('/front')}}/images/c1.jpg" title="" alt="" />
                                                        <section class="list-left">
                                                ...
                                                <a href="single.html">
                                                    <li>
                                                        <img src="{{asset('/front')}}/images/c2.jpg" title="" alt="" />
                                                        <section class="list-left">
                                                ...
                                                <a href="single.html">
                                                    <li>
                                                        <img src="{{asset('/front')}}/images/c3.jpg" title="" alt="" />
                                                        <section class="list-left">
                                                ...
                                                <a href="single.html">
                                                    <li>
                                                        <img src="{{asset('/front')}}/images/c4.jpg" title="" alt="" />
                                                        <section class="list-left">
                                                ...
                                                <a href="single.html">
                                                    <li>
                                                        <img src="{{asset('/front')}}/images/c5.jpg" title="" alt="" />
                                                        <section class="list-left">
                                                ...
                                                <a href="single.html">
                                                    <li>
                                                        <img src="{{asset('/front')}}/images/c6.jpg" title="" alt="" />
                                                        <section class="list-left">
                                                ...
                                                <a href="single.html">
                                                    <li>
                                                        <img src="{{asset('/front')}}/images/c7.jpg" title="" alt="" />
                                                        <section class="list-left">
                                                ...
                                                <a href="single.html">
                                                    <li>
                                                        <img src="{{asset('/front')}}/images/c8.jpg" title="" alt="" />
                                                        <section class="list-left">
                                                            <h5 class="title">There are many variations of passages of Lorem Ipsum</h5>
                                                ...
                                                <a href="single.html">
                                                    <li>
                                                        <img src="{{asset('/front')}}/images/c9.jpg" title="" alt="" />
                                                        <section class="list-left">
                                                ...
                                                <a href="single.html">
                                                    <li>
                                                        <img src="{{asset('/front')}}/images/c10.jpg" title="" alt="" />
                                                        <section class="list-left">
                                                            <h5 class="title">There are many variations of passages of Lorem Ipsum</h5>
                                                ...
                                                <a href="single.html">
                                                    <li>
                                                        <img src="{{asset('/front')}}/images/c11.jpg" title="" alt="" />
                                                        <section class="list-left">
                                                ...
                                                <a href="single.html">
                                                    <li>
                                                        <img src="{{asset('/front')}}/images/c12.jpg" title="" alt="" />
                                                        <section class="list-left">
                                                ...
                                                <a href="single.html">
                                                    <li>
                                                        <img src="{{asset('/front')}}/images/c13.jpg" title="" alt="" />
                                                        <section class="list-left">
